        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <div class="title">Edit: <?php echo e($user->name); ?> (<?php echo e($user->id); ?>)</div>
                </div>
            </div>
            <div class="card-body">
                ...
                <?php echo e(Form::open(array('url' => '/admin/dashboard/users/' . $user->id . '/edit'))); ?>

                <?php echo csrf_field(); ?>

                <div class="control">
                    <div class="sub-title">Name</div>
                    <?php echo e(Form::text('name', $user->name, array('class' => 'form-control', 'placeholder' => 'Name'))); ?>

                </div>
                <div class="control">
                    <div class="sub-title">Email</div>
                    <?php echo e(Form::text('email', $user->email, array('class' => 'form-control', 'placeholder' => 'Email'))); ?>

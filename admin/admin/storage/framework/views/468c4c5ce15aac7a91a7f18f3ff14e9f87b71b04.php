<?php $__env->startSection('title', 'Add video'); ?>
    ...
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?php echo e(Form::open(array('url' => '/admin/dashboard/videos/create'))); ?>

                <?php echo csrf_field(); ?>

                <div class="control">
                    <div class="sub-title">Quality</div>
                    <?php echo e(Form::text('quality', Input::old('quality'), array('class' => 'form-control'))); ?>

                </div>
                <div class="control">
                    <div class="sub-title">Extension</div>
                    <?php echo e(Form::text('extension', Input::old('extension'), array('class' => 'form-control'))); ?>

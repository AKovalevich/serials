...
<head>
    ...
    <?php echo e(Html::style('css/animate.min.css')); ?>

    <?php echo e(Html::style('css/bootstrap-switch.min.css')); ?>

    <?php echo e(Html::style('css/checkbox3.min.css')); ?>

    <?php echo e(Html::style('css/jquery.dataTables.min.css')); ?>

    <?php echo e(Html::style('css/dataTables.bootstrap.css')); ?>

    <?php echo e(Html::style('css/select2.min.css')); ?>

    <?php echo e(Html::style('css/style.css')); ?>

    <?php echo e(Html::style('css/themes/flat-blue.css')); ?>
...
<body class="flat-blue <?php echo $__env->yieldContent('body-class', ''); ?>">
...
<?php echo e(Html::script('js/Chart.min.js')); ?>

<?php echo e(Html::script('js/bootstrap-switch.min.js')); ?>

<?php echo e(Html::script('js/jquery.matchHeight-min.js')); ?>

<?php echo e(Html::script('js/jquery.dataTables.min.js')); ?>

<?php echo e(Html::script('js/dataTables.bootstrap.min.js')); ?>

<?php echo e(Html::script('js/select2.full.min.js')); ?>

<?php echo e(Html::script('js/ace/ace.js')); ?>

<?php echo e(Html::script('js/ace/mode-html.js')); ?>

<?php echo e(Html::script('js/ace/theme-github.js')); ?>

<?php echo e(Html::script('js/app.js')); ?>

<?php echo e(Html::script('js/index.js')); ?>
